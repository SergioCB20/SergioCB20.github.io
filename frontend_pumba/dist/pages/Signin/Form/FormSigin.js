...
export default function FormSigin() {
  ...
  const validateForm = () => {
    ...
    console.log("phoneRegex.test(phoneNumberString):", phoneRegex.test(formData.phone_number));
    console.log("dateRegex.test(birthdayString):", dateRegex.test(formData.birthday));
    ...
    Object.keys(formData).forEach(fieldName => {
      if (fieldName !== "birthday" && fieldName !== "address" && typeof formData[fieldName] === "string" && formData[fieldName].trim() === "") {
  ...
  }, currentStep === 1 && /*#__PURE__*/React.createElement(Step1, null), currentStep === 2 && /*#__PURE__*/React.createElement(Step2, null), currentStep === 3 && /*#__PURE__*/React.createElement(Step3, null), {
    signinError
  } && /*#__PURE__*/React.createElement("p", {
    className: "text-center text-red-600 text-bold mt-2 bg-white "
  }, signinError)));
}