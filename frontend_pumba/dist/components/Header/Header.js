...
const Header = () => {
  const ofertas = ["Las mejores marcas en un mismo lugar", "¡No somos una copia!", "En realidad sí 😉", "Disfruta de articulos exclusivos con PumbaPLUS"];
  const categorias = [{
    nombre: "Promociones",
    url: "/Shop/Promotions"
  }, {
  ...
  return /*#__PURE__*/React.createElement("header", {
    className: `fixed inset-x-0 inset-y-0 w-screen ${isLogin ? "hidden" : ""}`
  }, /*#__PURE__*/React.createElement(HeaderPromo, {
    ofertas: ofertas
